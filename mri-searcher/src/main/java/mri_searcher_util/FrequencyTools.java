...
public class FrequencyTools {
	...
	public static List<String> getBestTermsByTfIdf(IndexReader reader, List<String> queryContent, String field,TopDocs topDocs, int top,int ndr) throws IOException {
		...
		for (int j=0;j<terminosTfIdf.size();j++){
